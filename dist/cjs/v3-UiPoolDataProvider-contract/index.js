...
const UiPoolDataProvider__factory_1 = require("../types/factories/UiPoolDataProvider__factory");
...
class UiPoolDataProvider {
    ...
    constructor(context) {
        ...
        this._contract = UiPoolDataProvider__factory_1.UiPoolDataProvider__factory.connect(context.uiPoolDataProviderAddress, context.provider);
    ...
    async getReservesHumanized({ lendingPoolAddressProvider, }) {
        ...
        const reservesData = reservesRaw.map(reserveRaw => ({
            ...
            hTokenAddress: reserveRaw.hTokenAddress.toString(),
    ...
    async getUserReservesHumanized({ lendingPoolAddressProvider, user, }) {
        ...
        return {
            userReserves: userReservesRaw.map(userReserveRaw => ({
                ...
                scaledATokenBalance: userReserveRaw.scaledHTokenBalance.toString(),
