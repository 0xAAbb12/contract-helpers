...
export interface PoolInterface extends utils.Interface {
    functions: {
        ...
        "getFeeToVault()": FunctionFragment;
        "getFeeToVaultPercent()": FunctionFragment;
        ...
        "repayWithHTokens(address,uint256,uint256)": FunctionFragment;
        ...
        "setFeeToVault(address)": FunctionFragment;
        "setLendingGauge(address,address)": FunctionFragment;
        ...
        "updateFeeToVaultPercent(uint256)": FunctionFragment;
        "updateFlashloanPremiums(uint128,uint128)": FunctionFragment;
        "withdraw(address,uint256,address)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "ADDRESSES_PROVIDER" | "BRIDGE_PROTOCOL_FEE" | "FLASHLOAN_PREMIUM_TOTAL" | "FLASHLOAN_PREMIUM_TO_PROTOCOL" | "MAX_NUMBER_RESERVES" | "MAX_STABLE_RATE_BORROW_SIZE_PERCENT" | "POOL_REVISION" | "backUnbacked" | "borrow" | "configureEModeCategory" | "deposit" | "dropReserve" | "finalizeTransfer" | "flashLoan" | "flashLoanSimple" | "getConfiguration" | "getEModeCategoryData" | "getFeeToVault" | "getFeeToVaultPercent" | "getReserveAddressById" | "getReserveData" | "getReserveNormalizedIncome" | "getReserveNormalizedVariableDebt" | "getReservesList" | "getUserAccountData" | "getUserConfiguration" | "getUserEMode" | "initReserve" | "initialize" | "liquidationCall" | "mintToTreasury" | "mintUnbacked" | "rebalanceStableBorrowRate" | "repay" | "repayWithHTokens" | "repayWithPermit" | "rescueTokens" | "resetIsolationModeTotalDebt" | "setConfiguration" | "setFeeToVault" | "setLendingGauge" | "setReserveInterestRateStrategyAddress" | "setUserEMode" | "setUserUseReserveAsCollateral" | "supply" | "supplyWithPermit" | "swapBorrowRateMode" | "updateBridgeProtocolFee" | "updateFeeToVaultPercent" | "updateFlashloanPremiums" | "withdraw"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getFeeToVault", values?: undefined): string;
    encodeFunctionData(functionFragment: "getFeeToVaultPercent", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "repayWithHTokens", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>
    ]): string;
    ...
    encodeFunctionData(functionFragment: "setFeeToVault", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "setLendingGauge", values: [PromiseOrValue<string>, PromiseOrValue<string>]): string;
    ...
    encodeFunctionData(functionFragment: "updateFeeToVaultPercent", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    decodeFunctionResult(functionFragment: "getFeeToVault", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getFeeToVaultPercent", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "repayWithHTokens", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setFeeToVault", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setLendingGauge", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "updateFeeToVaultPercent", data: BytesLike): Result;
...
export interface Pool extends BaseContract {
    ...
    functions: {
        ...
        getFeeToVault(overrides?: CallOverrides): Promise<[string]>;
        getFeeToVaultPercent(overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        initReserve(asset: PromiseOrValue<string>, hTokenAddress: PromiseOrValue<string>, stableDebtAddress: PromiseOrValue<string>, variableDebtAddress: PromiseOrValue<string>, interestRateStrategyAddress: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        initialize(provider: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        liquidationCall(collateralAsset: PromiseOrValue<string>, debtAsset: PromiseOrValue<string>, user: PromiseOrValue<string>, debtToCover: PromiseOrValue<BigNumberish>, receiveHToken: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        repayWithHTokens(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, interestRateMode: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        setFeeToVault(feeToVault: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setLendingGauge(asset: PromiseOrValue<string>, lendingGauge: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        updateFeeToVaultPercent(feeToVaultPercent: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getUserConfiguration(user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<DataTypes.UserConfigurationMapStructOutput>;
        getUserEMode(user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        initReserve(asset: PromiseOrValue<string>, hTokenAddress: PromiseOrValue<string>, stableDebtAddress: PromiseOrValue<string>, variableDebtAddress: PromiseOrValue<string>, interestRateStrategyAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        initialize(provider: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        liquidationCall(collateralAsset: PromiseOrValue<string>, debtAsset: PromiseOrValue<string>, user: PromiseOrValue<string>, debtToCover: PromiseOrValue<BigNumberish>, receiveHToken: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        ...
        repayWithHTokens(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, interestRateMode: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        setFeeToVault(feeToVault: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        setLendingGauge(asset: PromiseOrValue<string>, lendingGauge: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        ...
        updateFeeToVaultPercent(feeToVaultPercent: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "LiquidationCall(address,address,address,uint256,uint256,address,bool)"(collateralAsset?: PromiseOrValue<string> | null, debtAsset?: PromiseOrValue<string> | null, user?: PromiseOrValue<string> | null, debtToCover?: null, liquidatedCollateralAmount?: null, liquidator?: null, receiveHToken?: null): LiquidationCallEventFilter;
        LiquidationCall(collateralAsset?: PromiseOrValue<string> | null, debtAsset?: PromiseOrValue<string> | null, user?: PromiseOrValue<string> | null, debtToCover?: null, liquidatedCollateralAmount?: null, liquidator?: null, receiveHToken?: null): LiquidationCallEventFilter;
        ...
        "Repay(address,address,address,uint256,bool)"(reserve?: PromiseOrValue<string> | null, user?: PromiseOrValue<string> | null, repayer?: PromiseOrValue<string> | null, amount?: null, useHTokens?: null): RepayEventFilter;
        Repay(reserve?: PromiseOrValue<string> | null, user?: PromiseOrValue<string> | null, repayer?: PromiseOrValue<string> | null, amount?: null, useHTokens?: null): RepayEventFilter;
    ...
    estimateGas: {
        ...
        getFeeToVault(overrides?: CallOverrides): Promise<BigNumber>;
        getFeeToVaultPercent(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getFeeToVault(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getFeeToVaultPercent(overrides?: CallOverrides): Promise<PopulatedTransaction>;
