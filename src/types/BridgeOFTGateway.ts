...
export interface BridgeOFTGatewayInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "isTrustedRemote"
      | "listBridgeTrustChainList"
      | "listBridgeTrustChainTokenList"
      | "listTokenSets"
      | "lzEndpoint"
      | "lzReceive"
      | "minDstGasLookup"
  ...
  encodeFunctionData(
    functionFragment: "listBridgeTrustChainList",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "listBridgeTrustChainTokenList",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "listTokenSets",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "removeBridgeToken",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTrustDstInfo",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>
  ...
  encodeFunctionData(
    functionFragment: "updateBridgeToken",
    values: [
      PromiseOrValue<boolean>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>
...
export type SendToChainEvent = TypedEvent<
  [number, string, string, string, string, BigNumber],
...
export interface BridgeOFTGateway extends BaseContract {
  ...
  functions: {
    ...
    addBridgeToken(
      _canMintAndBurn: PromiseOrValue<boolean>,
    ...
    estimateSendAndCallFee(
      ...
      _token: PromiseOrValue<string>,
      _dstTokenAddress: PromiseOrValue<BytesLike>,
    ...
    sendAndCall(
      ...
      _payload: PromiseOrValue<BytesLike>,
      _dstGasForCall: PromiseOrValue<BigNumberish>,
      _callParams: ICommonOFTGateway.LzCallParamsStruct,
      overrides?: PayableOverrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "ReceiveFromChain(uint16,address,address,uint256)"(
      _srcChainId?: PromiseOrValue<BigNumberish> | null,
      _token?: null,
