...
export class LendingGauge__factory {
  static readonly abi = _abi;
  static createInterface(): LendingGaugeInterface {
    return new utils.Interface(_abi) as LendingGaugeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LendingGauge {
    return new Contract(address, _abi, signerOrProvider) as LendingGauge;
  }
}
